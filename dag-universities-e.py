...
with DAG(
    ...
    try:
        ...
        logger.info(" Universidad Nacional De La Pampa ")
        logger.info(" Universidad Abierta Interamericana ")
    except:
        logger.error(" Universidad Nacional De La Pampa ")
        logger.error(" Universidad Abierta Interamericana ")
